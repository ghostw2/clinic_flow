# Graph Report - clinicflow  (2026-06-19)

## Corpus Check
- 148 files · ~52,892 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 895 nodes · 1802 edges · 64 communities (56 shown, 8 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 242 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea56f091`
...
Cohesion: 0.08
Nodes (35): AppointmentDetailSheetProps, DetailsForm, detailsSchema, DetailsTab(), DOC_TYPES, DocumentsTab(), STATUS_LABELS, STATUS_OPTIONS (+27 more)

### Community 7 - "Patient UI Components"
Cohesion: 0.13
Nodes (22): medicalRecordsApi, notificationsApi, PatientPayload, permissionsApi, PUBLIC_PATHS, RecordPayload, ApiError, AppointmentDocument (+14 more)

### Community 8 - "Calendar & Appointments Page"
Cohesion: 0.11
Nodes (24): toFormDefaults(), PatientDetailPage(), usersApi, AuditTrailTab(), AuditTrailTabProps, VitalsSection(), VitalsSectionProps, PERMISSION_ROWS (+16 more)

### Community 9 - "Navigation & Dashboard Cards"
Cohesion: 0.14
Nodes (15): AppointmentDayCard(), AppointmentDayCardProps, AppointmentDetailSheet(), DayScheduleView(), DayScheduleViewProps, DOCTOR_COLORS, doctorColor(), toDateKey() (+7 more)
...
Cohesion: 0.05
Nodes (57): AppLayout(), inter, metadata, Navbar(), NavbarProps, PatientCard(), PatientCardProps, NAV_ITEMS (+49 more)

### Community 12 - "Appointment Forms & Tabs"
Cohesion: 0.13
Nodes (18): AppointmentsPage(), CalendarView(), CalendarViewProps, STATUS_COLORS, usePermissions(), Cell, downloadCSV(), downloadExcel() (+10 more)
...
Cohesion: 0.29
Nodes (6): SheetContentProps, SheetDescription, SheetFooter(), SheetOverlay, SheetTitle, sheetVariants
...
Cohesion: 0.15
Nodes (16): colorMap, StatsCard(), StatsCardProps, cn(), formatDate(), formatDateTime(), formatTime(), Badge() (+8 more)
...
## Knowledge Gaps
- **289 isolated node(s):** `schema`, `FormData`, `BLOOD_TYPES`, `AppointmentDayCardProps`, `schema` (+284 more)
...
- **What connects `schema`, `FormData`, `BLOOD_TYPES` to the rest of the system?**
